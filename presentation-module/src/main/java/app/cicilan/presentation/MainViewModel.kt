package app.cicilan.presentation
...
import app.cicilan.util.runInBackground
...
class DetailViewModel(
    ...
    private val _getLog = MutableSharedFlow<State<List<ItemLogEntity>>>(1)
    val loadLogCicilan get() = _getLog
    fun getLog(id: String) = runInBackground {
