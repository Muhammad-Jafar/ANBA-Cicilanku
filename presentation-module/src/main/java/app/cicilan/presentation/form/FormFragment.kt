...
import app.cicilan.presentation.FormViewModel
import app.cicilan.presentation.R
import app.cicilan.presentation.databinding.DialogPickImageBinding
import app.cicilan.presentation.databinding.MainFormBinding
import app.cicilan.util.addAutoConverterToMoneyFormat
import app.cicilan.util.afterInputNumberChanged
import app.cicilan.util.afterInputStringChanged
...
class FormFragment : BaseFragment<MainFormBinding>(MainFormBinding::inflate) {
    ...
    private fun loadData(item: ModalForm) = with(binding) {
